...
X_train = loadData('F:/Ml/UCI HAR Dataset/UCI HAR Dataset/train/X_train.txt')
y_train = loadData('F:/Ml/UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt')
X_test = loadData('F:/Ml/UCI HAR Dataset/UCI HAR Dataset/test/X_test.txt')
y_test = loadData('F:/Ml/UCI HAR Dataset/UCI HAR Dataset/test/y_test.txt')
